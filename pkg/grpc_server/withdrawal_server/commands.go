...
import (
	...
	getVersion "intmax2-withdrawal/internal/use_cases/get_version"
	postWithdrawalRequest "intmax2-withdrawal/internal/use_cases/post_withdrawal_request"
	postWithdrawalsByHashes "intmax2-withdrawal/internal/use_cases/post_withdrawals_by_hashes"
	"intmax2-withdrawal/internal/withdrawal_service"
	ucGetVersion "intmax2-withdrawal/pkg/use_cases/get_version"
	ucPostWithdrawalRequest "intmax2-withdrawal/pkg/use_cases/post_withdrawal_request"
	ucPostWithdrawalsByHashes "intmax2-withdrawal/pkg/use_cases/post_withdrawals_by_hashes"
)
